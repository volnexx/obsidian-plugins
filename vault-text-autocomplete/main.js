...
var DEFAULT_HISTORIES_PATH = ".obsidian/plugins/vault-text-autocomplete/histories.json";
...
var VaultTextAutocompleteSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  async display() {
    ...
    containerEl.createEl("h2", {
      text: "\u0410\u0432\u0442\u043E\u0434\u043E\u043F\u043E\u043B\u043D\u0435\u043D\u0438\u0435 \u0442\u0435\u043A\u0441\u0442\u0430 \u043F\u043E \u0445\u0440\u0430\u043D\u0438\u043B\u0438\u0449\u0443"
    });
  ...
  async addMainSettings(containerEl) {
    ...
    const group = new import_obsidian2.SettingGroup(containerEl);
  ...
  addMobileSettings(containerEl) {
    ...
    new import_obsidian2.Setting(containerEl).setName("Disable on mobile").addToggle((tc) => {
  ...
  async toggleMatchStrategy() {
    switch (this.plugin.settings.matchStrategy) {
      ...
      case "partial":
        ...
        break;
      default:
        new import_obsidian2.Notice("\u26A0Unexpected error");
    }
    await this.plugin.saveSettings();
  }
...
var CustomDictionaryWordProvider = class {
  ...
  async loadWords(path2, option) {
    const contents = isURL(path2) ? await (0, import_obsidian3.request)({ url: path2 }) : await this.fileSystemAdapter.read(path2);
...
var AutoCompleteSuggest = class _AutoCompleteSuggest extends import_obsidian4.EditorSuggest {
  ...
  async updateSettings(settings) {
    ...
    this.registerKeyboardPassThrough();
  }
  registerKeyAsPassThrough(modifiers, key) {
  ...
  registerKeyboardPassThrough() {
    ...
    this.scope.keys.filter(
      (x) => {
        var _a;
        return passThroughKeys.map((x2) => x2.toLowerCase()).includes(((_a = x.key) != null ? _a : "").toLowerCase());
      }
    ...
    passThroughKeys.forEach((x) => this.registerKeyAsPassThrough([], x));
  }
...
// src/main.ts
var VaultTextAutocomplete = class extends import_obsidian6.Plugin {
  onunload() {
    super.onunload();
  ...
  async onload() {
    ...
    this.settingTab = new VaultTextAutocompleteSettingTab(this.app, this);
    ...
    this.addCommand({
      ...
      callback: async () => {
        ...
        new import_obsidian6.Notice("\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 \u0430\u0432\u0442\u043E\u0434\u043E\u043F\u043E\u043B\u043D\u0435\u043D\u0438\u044F \u0441\u043A\u043E\u043F\u0438\u0440\u043E\u0432\u0430\u043D\u044B");
      }
    });
  }
  async loadSettings() {
