...
Search is a compatibility-preserving fork of Omnisearch. It keeps the
`omnisearch` plugin identifier and public API so integrations such as Home Tab
continue to work without changes.

Search adds strict title ranking: an exact note-title match always appears
before title-prefix matches, and title-prefix matches appear before all other
results.

The original project was created by Simon Cambier and is available at
[scambier/obsidian-omnisearch](https://github.com/scambier/obsidian-omnisearch).

## Original Omnisearch documentation
